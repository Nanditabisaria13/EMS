  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="p-4 py-5 flex items-center justify-center gap-20 w-full mt-5">
        <form
          className="p-10 bg-white border drop-shadow-md flex flex-col items-center justify-between gap-5 rounded-xl m-auto
                      dark:bg-[#1a1a1a] dark:border-[#535353]"
          onSubmit={submitHandler}
        >
          <h1 className="font-medium text-2xl text-emerald-800 dark:text-emerald-400">
            Welcome, Login to your Dashboard
          </h1>
          ...
          {state === "Admin" ? (
            <div className="w-full flex flex-col gap-5 items-center">
              <button
                type="submit"
                className="bg-emerald-600 text-white px-4 py-2 w-full text-lg font-light rounded-lg"
              >
                Sign in
              </button>
              <p className="text-base font-normal text-zinc-900 dark:text-zinc-200">
                Login as an employee?
                <Link
                  onClick={() => setState("employee")}
                  className="text-emerald-600 font-medium text-xl underline cursor-pointer dark:text-emerald-500"
                >
                  Login Employee
                </Link>{" "}
              </p>
            ...
            <div className="w-full flex flex-col gap-5 items-center">
              ...
              <p className="text-base font-normal text-zinc-900 dark:text-zinc-200">
                ...
                <Link
                  ...
                  className="text-emerald-600 font-medium text-xl underline cursor-pointer"
                >
                  Login Admin
                </Link>{" "}
              </p>
