    ...
    <div className="w-full flex items-start">
      ...
      <div className="w-full  sm:ml-[8.5rem] md:ml-[19.6rem] overflow-hidden">
        ...
        <div className="px-4 py-3 pt-28 w-full bg-slate-50 dark:bg-[#101013]">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 px-3 mt-3 cursor-pointer">
           {/* Leave Stats Cards  */}
          ...
          <div className="flex gap-4">
            <label className="inline-flex items-center">
              <input
                ...
                name="durationType"
                value="days"
                checked={leaveDetails.durationType === "days"}
                onChange={handleChange}
                className="mr-2"
              />
              Days
            ...
            <label className="inline-flex items-center">
              <input
                ...
                name="durationType"
                value="weeks"
                checked={leaveDetails.durationType === "weeks"}
                onChange={handleChange}
                className="mr-2"
              />
              Weeks
            ...
            <label className="inline-flex items-center">
              <input
                ...
                name="durationType"
                value="months"
                checked={leaveDetails.durationType === "months"}
                onChange={handleChange}
                className="mr-2"
              />
              Months
          ...
          >
            ...
            <div className="overflow-x-auto">
              <div className="mt-5 mb-2 py-2 px-4 flex items-center justify-between gap-6 lg:gap-1 rounded w-fit md:w-full bg-emerald-500">
                ...
                <h5 className="text-lg font-base w-32">
                  Requested On
                </h5>
              ...
              <div className="overflow-y-auto w-fit md:w-full max-h-[50vh] lg:max-h-[40vh]">
                {leaveData.map((item, index) => (
                  ...
                  >
                    <h5 className="text-lg font-normal w-32 text-neutral-900-400">
                      {item.leaveType}
                    </h5>
                    ...
                    <h5 className="  text-lg font-normal w-32 text-blue-500">
                      {item.startDate}
                    </h5>
