...
const EmployeeTasksBoard = () => {
  ...
  return (
    ...
    <Sidebar/>
    <div className=' w-full sm:w-[80%] md:w-[73%] lg:w-[75%] xl:w-[80%] sm:ml-[8.5rem] md:ml-[19.6rem]'>
      
     <EmployeeNavbar/>
  
     <div className='px-4 py-3 w-full bg-slate-50 dark:bg-[#101013] relative'>
     <h1 className='font-medium text-2xl text-neutral-800 dark:text-white'>Task Board</h1>

     <div className='mt-4 flex flex-col gap-3 w-full'>
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 px-3 w-full'>

             
          <div className='bg-white drop-shadow-md border border-zinc-300  flex justify-between items-start  gap-2 p-4 px-4 rounded-xl
                          dark:bg-[#1a1a1a] dark:border-[#535353]'>
          <div className='flex flex-col gap-2'>
          <h2 className='text-lg font-medium leading-tight text-yellow-500'>New Tasks</h2>
          <p className='font-semibold text-3xl text-neutral-800 dark:text-white'>{profile.taskNumbers.newTask}</p>
          </div>
          ...
          <div className='bg-white drop-shadow-md border border-zinc-300 flex justify-between items-start  gap-2 p-4 px-4 rounded-xl
                     dark:bg-[#1a1a1a] dark:border-[#535353]'>
          <div className='flex flex-col gap-2'>       
          <h2 className='text-lg font-medium leading-tight text-blue-500'>Active Tasks</h2>
          <p className='font-semibold text-3xl text-neutral-800 dark:text-white'>{profile.taskNumbers.active}</p>
          </div>
          ...
          <div className='bg-white drop-shadow-md border border-zinc-300 flex justify-between items-start  gap-2 p-4 px-4 rounded-xl
                      dark:bg-[#1a1a1a] dark:border-[#535353]'>
          <div className='flex flex-col gap-2'>
          <h2 className='text-lg font-medium leading-tight text-green-500'>Completed Tasks</h2>
          <p className='font-semibold text-3xl text-neutral-800 dark:text-white'>{profile.taskNumbers.completed}</p>
          </div>
          ...
          <div className='bg-white drop-shadow-md border border-zinc-300 flex justify-between items-start  gap-2 p-4 px-4 rounded-xl
                             dark:bg-[#1a1a1a] dark:border-[#535353]'>
          <div className='flex flex-col gap-2'>
          <h2 className='text-lg font-medium leading-tight text-red-500'>Failed Tasks</h2>
          <p className='font-semibold text-3xl text-neutral-800 dark:text-white'>{profile.taskNumbers.failed}</p>
          </div>
          ...
          <div id='tasklist' className=' py-5 flex-1 mt-5 w-full'>
           ...
           <div className='flex gap-3  overflow-x-auto w-[100%]'>
            ...
            <div className='flex flex-col gap-2 h-screen p-3'>
             <div className='w-full flex gap-3 items-center justify-between py-3 px-2 bg-white drop-shadow-md border-zinc-300
              dark:bg-[#1a1a1a] border dark:border-[#535353] rounded-lg'>
            <h1 className='font-medium text-2xl text-yellow-500'>New Tasks</h1>
          ...
          <div className='w-full flex gap-3 items-center justify-between py-3 px-2 bg-white drop-shadow-md border-zinc-300
           dark:bg-[#1a1a1a] border dark:border-[#535353] rounded-lg'>
            <h1 className='font-medium text-2xl text-blue-500'>Active Tasks</h1>
          ...
          <div className='flex flex-col h-screen gap-2  p-3'>
            <div className='w-full flex gap-3 items-center justify-between py-3 px-2 bg-white drop-shadow-md border-zinc-300
             dark:bg-[#1a1a1a] border dark:border-[#535353] rounded-lg'>
            <h1 className='font-medium text-2xl text-emerald-500 '>Completed Tasks</h1>
