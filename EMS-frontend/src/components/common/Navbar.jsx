  ...
  return (
    ...
    >
      <div className="logo">
        <h1
          onClick={() => navigate("/")}
          className="text-emerald-800 font-semibold text-3xl dark:text-emerald-500 cursor-pointer"
        >
          E.M.S.
        </h1>
      </div>
      ...
      <div className="flex items-center justify-between gap-3 sm:gap-5">
        ...
        <i
          onClick={() => navigate("/signup")}
          className="ri-account-box-line text-2xl text-neutral-800 dark:text-white block sm:hidden"
        ></i>
        <button
        ...
        <i
          onClick={() => navigate("/login")}
          className="ri-login-box-line text-2xl text-neutral-800 dark:text-white block sm:hidden"
        ></i>
      </div>
    </div>
  );
