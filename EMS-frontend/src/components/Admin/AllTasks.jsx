      ...
      <div className="overflow-x-auto">
        ...
        <div className="overflow-y-auto w-fit md:w-full max-h-[50vh]">
          {allEmployees.map((employee, index) => (
            ...
            >
              <div className="w-32 lg:w-1/5 flex items-center gap-2">
                <img
                  src={employee.image}
              ...
              <h5 className="text-lg font-medium w-32 lg:w-1/5 text-yellow-400">
                {employee.taskNumbers.newTask}
              </h5>
              <h3 className="text-lg font-medium w-32 lg:w-1/5 text-blue-400">
                {employee.taskNumbers.active}
              </h3>
              <h5 className="text-lg font-medium w-32 lg:w-1/5 text-green-400">
                {employee.taskNumbers.completed}
              </h5>
              <h5 className="text-lg font-medium w-32 lg:w-1/5 text-red-500">
