  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        backendUrl + "/api/admin/add-newTask",
        dataToSend,
        { headers: { aToken } }
      );
      ...
      >
        <div className="w-full ">
          <div className="flex flex-col gap-2 w-full ">
            <h3 className="text-base text-gray-900 mb-0.5 dark:text-white">
              Task Title
            </h3>
            <input
        ...
        <div className="glex flex-col gap-4">
          ...
          <div className=" flex flex-col gap-2">
            ...
            <textarea
              className="w-full h-44 text-sm py-2 px-4 bg-transparent rounded outline-none border-[1px] border-gray-600"
              name=""
              id=""
              value={description}
