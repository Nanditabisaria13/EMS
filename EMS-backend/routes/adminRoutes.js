...
router.post('/completed-task', authMiddlewares.authAdmin , adminController.taskCompleted)
router.post('/failed-task', authMiddlewares.authAdmin , adminController.taskFailed)
